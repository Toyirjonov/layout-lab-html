    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <div className="bg-card rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="bg-muted p-12 flex flex-col items-center justify-center border-b border-border">
            <CreditCard className="w-16 h-16 text-destructive mb-4" />
            <h3 className="text-2xl font-semibold text-destructive mb-4">Payment declined</h3>
          ...
          <div className="p-8">
            ...
            <div className="bg-secondary/30 p-4 rounded-lg mb-8 text-sm text-center">
              <p>If you have any questions about the transaction status</p>
              <p>you can contact you issuing bank</p>
            </div>
